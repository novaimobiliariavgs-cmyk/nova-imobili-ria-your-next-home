...
const info = [
  { icon: MapPin, label: "Endereço", value: "Rua Principal, 123 — Centro, Vargem Grande do Sul/SP" },
  { icon: Phone, label: "Telefone", value: "(19) 99999-9999" },
            ...
            <ScrollReveal>
              <div className="space-y-6">
                ...
                <div className="aspect-video rounded-xl bg-muted overflow-hidden mt-4">
                  <iframe
                    title="Localização"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29608.71817073!2d-46.90!3d-21.83!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94b9e0a0a0a0a0a0%3A0x0!2sVargem%20Grande%20do%20Sul!5e0!3m2!1spt-BR!2sbr!4v1"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    loading="lazy"
            ...
            <ScrollReveal delay={100}>
              <div className="rounded-xl border border-border bg-card p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" variant="accent" size="lg" className="w-full">Enviar mensagem</Button>
                </form>
              </div>
            </ScrollReveal>
          </div>
